...
awk '{if($1~"ERCC") print $1,$2,$3,$4+$5}' /home/saba/tmp/total.bedgraph > $1.controls.plus.bedgraph
awk '{if($1~"ERCC") print $1,$2,$3,$6+$7}' /home/saba/tmp/total.bedgraph > $1.controls.minus.bedgraph
awk '{if($1!~"ERCC") print "chr"$1,$2,$3,$4+$5}' /home/saba/tmp/total.bedgraph > /home/saba/tmp/genome.minus.bedgraph
awk '{if($1!~"ERCC") print "chr"$1,$2,$3,$6+$7}' /home/saba/tmp/total.bedgraph > /home/saba/tmp/genome.plus.bedgraph
