...
malesPravenec$brain[malesPravenec$sample %in% batch3] = "libraries being prepped (25Sep14)"
malesPravenec$brain[malesPravenec$sample=="SHR_1"] = paste(malesPravenec$brain[malesPravenec$sample=="SHR_1"],"; REPLICATE2 libraries being prepped (25Sep14)",sep="")
```
