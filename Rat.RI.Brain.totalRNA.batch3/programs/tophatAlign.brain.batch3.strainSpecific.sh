...
tophat2 --library-type fr-firststrand -o /storage/saba/Rat.RI.Brain.totalRNA.batch3/alignedReads/SHR1.ss -p 16 /storage/saba/index/SHR_rn5_wSpikesAndM /storage/saba/Rat.RI.Brain.totalRNA.batch3/cleanedReads/SHR_1.no_rRNA.end1.fq /storage/saba/Rat.RI.Brain.totalRNA.batch3/cleanedReads/SHR_1.no_rRNA.end2.fq
