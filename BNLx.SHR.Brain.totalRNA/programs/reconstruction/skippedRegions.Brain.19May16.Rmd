...
```{r}
base.folder = "/Volumes/sabal/BNLx.SHR/RNA-Seq.Brain.total/reconstruction/"

bnlx = gtfFormat(read.table(file=paste(base.folder,"BNLx.Brain.total.rn6.ensemblGuided/skipped.gtf",sep=""),sep="\t",header=FALSE),FPKM=FALSE)
shr = gtfFormat(read.table(file=paste(base.folder,"SHR.Brain.total.rn6.ensemblGuided/skipped.gtf",sep=""),sep="\t",header=FALSE),FPKM=FALSE)
