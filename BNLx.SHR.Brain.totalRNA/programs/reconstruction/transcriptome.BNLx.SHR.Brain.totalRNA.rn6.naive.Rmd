...
###1.  Strain-Specific Transcriptome Reconstruction (unguided) - 

```
qsub -N BNLx.naive -q smp /storage/saba/BNLx.SHR.Brain.totalRNA/programs/reconBNLx.brain.naive.sh
qsub -N SHR.naive -q smp /storage/saba/BNLx.SHR.Brain.totalRNA/programs/reconSHR.brain.naive.sh
```
...
setwd("~/Documents/BNLx.SHR/RNA-Seq.Brain/reconstruction")
printNow=FALSE
