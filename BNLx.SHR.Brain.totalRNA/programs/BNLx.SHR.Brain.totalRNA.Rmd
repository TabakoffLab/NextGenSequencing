...
8.  Sort and merge BAM files by strain - BNLx is DONE, but SHR is RUNNING
----------------
```
...
9. Characterize aligned reads - BNLx is DONE, but SHR is waiting until sort and merge is done
-----------------------------
```
...
10.  Strain-Specific Transcriptome Reconstruction (Ensembl-Guided) - BNLx is RUNNING and SHR is waiting until sort and merge is done
--------------------------
```
