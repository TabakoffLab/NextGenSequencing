...
shr.tracking = read.table(file = paste(base.folder,"SHR.Heart.total.rn6.ensemblGuided/isoforms.fpkm_tracking",sep=""),sep="\t",header=TRUE)
bnlx.tracking = read.table(file = paste(base.folder,"BNLx.Heart.total.rn6.ensemblGuided/isoforms.fpkm_tracking",sep=""),sep="\t",header=TRUE)

high.bnlx = bnlx.tracking[bnlx.tracking$FPKM>0,]
high.bnlx = high.bnlx[high.bnlx$length>100,]
high.bnlx = high.bnlx[-grep("ERCC",high.bnlx$locus),]

high.shr = shr.tracking[shr.tracking$FPKM>0,]
high.shr = high.shr[high.shr$length>100,]
