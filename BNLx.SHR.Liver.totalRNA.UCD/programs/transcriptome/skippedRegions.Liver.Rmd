...
```{r}
base.folder = "/Volumes/sabal/BNLx.SHR/RNA-Seq.Liver/reconstruction/"

bnlx = gtfFormat(read.table(file=paste(base.folder,"BNLx.Liver.total.rn6.ensemblGuided/skipped.gtf",sep=""),sep="\t",header=FALSE),FPKM=FALSE)
shr = gtfFormat(read.table(file=paste(base.folder,"SHR.Liver.total.rn6.ensemblGuided/skipped.gtf",sep=""),sep="\t",header=FALSE),FPKM=FALSE)
