...
#####################
overlap <- read.table(file="RNA-Seq.Brain.polyA/reconstruction/tmp/overlap.brain.polyA.byStrain.txt",sep="\t",header=FALSE)
...
##  examine one-exon transcripts - 728 overlaps between one-exon transcripts
...
## close match one-exon transcripts - 332 transcripts
