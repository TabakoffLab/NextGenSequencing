---
title: "Compare Naive to Ensemble"
author: "Laura Saba"
...
shr.naive = read.table(file = "SHR.Brain.PolyA.naive.rn6/transcripts.gtf",sep="\t",header=FALSE)
shr.naive = gtfFormat(shr.naive)
...
bnlx.naive = read.table(file = "BNLx.Brain.PolyA.naive.rn6/transcripts.gtf",sep="\t",header=FALSE)
bnlx.naive = gtfFormat(bnlx.naive)
